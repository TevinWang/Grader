    ...
    return (
      <div className="Grader">
        <nav class="flex items-center justify-between flex-wrap bg-primary p-6">
          <div class="flex items-center flsex-shrink-0 text-white mr-6">
            <img src="https://cdn.discordapp.com/attachments/943383316046938113/945074095106695168/Grader.png" width="30" height="30"/>
